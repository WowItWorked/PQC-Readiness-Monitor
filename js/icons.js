/* PQC Readiness Monitor — inline icon set (Lucide outlines, embedded so the app
   has no runtime network dependency). Each entry is the inner markup of a
   24x24 stroked SVG. */

(function () {
  var SHIELD = '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1 1 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/>';
  ...
  var ICONS = {
    ...
    "rss": '<path d="M4 11a9 9 0 0 1 9 9"/><path d="M4 4a16 16 0 0 1 16 16"/><circle cx="5" cy="20" r="1"/>',
    "book-open": '<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>',
    "calendar": '<path d="M8 2v4"/><path d="M16 2v4"/><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M3 10h18"/>',
    "search": '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
    "x": '<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',
    "shield-check": SHIELD + '<path d="m9 12 2 2 4-4"/>',
    "shield-half": SHIELD + '<path d="M12 22V2"/>',
    "shield-x": SHIELD + '<path d="m14.5 9.5-5 5"/><path d="m9.5 9.5 5 5"/>',
    ...
    "circle-dashed": '<circle cx="12" cy="12" r="10" stroke-dasharray="4.2 3.4"/>',
  ...
  // icon(name, size, color) → inline SVG string. Color defaults to currentColor.
